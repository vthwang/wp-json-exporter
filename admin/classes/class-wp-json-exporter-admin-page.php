				...
				<form method="post" action="options.php">
					...
					<table class="form-table">
						<tr>
							...
							<td><input type="checkbox" name="wp_json_exporter_is_redirect" <?php checked(get_option('wp_json_exporter_is_redirect'), 1); ?> value="1"></td>
						</tr>
						<tr>
							<th scope="row">Redirect URL:</th>
							<td><input type="text" name="wp_json_exporter_redirect_url" value="<?php echo esc_attr(get_option('wp_json_exporter_redirect_url')); ?>"></td>
						</tr>
					</table>
